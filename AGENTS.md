...
src/
  ...
  components/
    ...
    SectionEditorModal.tsx # per-section editor (fields, per-field descriptions, move a field to another section, formulas, kind, colour, effects, action toggles) — opened from the ✎ popover's "More settings…"
